...
public class NetworkManager implements IGameInformation, IGameClientAction {
	...
	public void downNetworkGame() {
    	gameNotification.downNetworkGame();
	}
	...
	@Override
	public void joueurRentreTroupeau(String ram, String idp, String idm, String idt) {
    	if (ram.equals("OUI")) {
			EventManager.getInstance().pickUpHerd(Integer.parseInt(idp), Integer.parseInt(idm), Integer.parseInt(idt));
		}
	}

	@Override
	public void joueurAJouerCarte(String carteJouer, String uidPartie, String uidTour, String uidManche) {
		System.out.println("CARTE JOUE" + "-->" + EventManager.getInstance());
		EventManager.getInstance().playerPlayCard(carteJouer, Integer.parseInt(uidPartie), Integer.parseInt(uidTour), Integer.parseInt(uidManche));
	}

	@Override
	public void joueurInverseSensJeu(String inverserSensJeux, String uidPartie, String uidTour, String uidManche) {
    	boolean directionChange;

    	directionChange = inverserSensJeux.equals("OUI");
		EventManager.getInstance().changeDirection(directionChange, Integer.parseInt(uidPartie), Integer.parseInt(uidTour), Integer.parseInt(uidManche));
	}
