...
public class FacadeServer implements Facade, GameNotification {
	...
	public void informPlayerAction(boolean herdPickUp, String cardPlay, boolean reverseDirection, int gameID,
		...
		if(herdPickUp == true && reverseDirection == true) {
			ArrayList<String> message = new ArrayList<>();
			//7
			message.add("IAT");
			message.add(""+herdPickUp);
			message.add(cardPlay);
			message.add(""+reverseDirection);
			message.add(""+gameID);
			message.add(""+roundID);
			message.add(""+turnID);
			String msg = e.splitTxt(message);
		...
		else if (herdPickUp == true && cardPlay == null ){
			//6
			ArrayList<String> message = new ArrayList<>();
			message.add("IAT");
			message.add(""+herdPickUp);
