export default {
  ...
  rules: {
    ...
    block1: {
      ...
      c: 'Une partie se joue en plusieurs manches.',
    ...
    block3: {
      ...
      f: 'Sans valeur = à placer entre 2 cartes n’ayant pas de numéro consécutifs',
    ...
    block4: {
      ...
      b: 'Si un jouer ne peut pas jouer : il ramasse le troupeau et les mouches vont dans son étable.',
      c: '/!\\ Un joueur peut ramasser s’il le souhaite même s’il peut jouer.',
      d: 'Quand un joueur ramasse, c’est à lui de jouer la première carte.'
    },
    title5: 'Fin de la partie :',
    block5: {
      a:'Manche',
      b: 'Chaque partie est découpée en plusieurs manches. Une manche se termine quand il n’y a plus de pioche : quand il n’y a plus de pioche, le tour en cours se termine et lorsqu’un joueur ramasse, c’est la fin de la manche, les cartes restantes dans les mains des joueurs vont automatiquement dans leurs étables respectives. Chaque mouche est comptée et constitue le score de ma manche.',
      c: 'Partie',
