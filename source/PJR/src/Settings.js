...
class Settings extends Component {
  ...
  render() {
    ...
    const {locale, effectVolume} = this.state;
    const {lang, availableLocales, theme} = settings;
        ...
        <div className={classes.themes}>
          {
            themes.map(t =>{
              return (
                <div className={`${classes.themeBorder} ${theme === t.key ? classes.themeActive : ''}`} onClick={this.handleSetTheme(t.key)}>
