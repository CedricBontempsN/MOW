...
public class AnalyseClientTCP extends AnalyseTCP implements TCPListener{
	...
	private void notificationInformerActionTurn(ArrayList<String> valueData) {
			if(valueData.size() == 7) {
				boolean i1 = Boolean.parseBoolean(valueData.get(1));
				boolean i3 = Boolean.parseBoolean(valueData.get(3));
				int i4 = Integer.parseInt(valueData.get(4));
				int i5 = Integer.parseInt(valueData.get(5));
				int i6 = Integer.parseInt(valueData.get(6));
				igsa.serverInformPlayerActionTRandReverseGame(i1, valueData.get(2), i3, i4, i5, i6);
			}
			else if(valueData.size() == 5 && !valueData.get(1).equals("true")) {
				
					int i4 = Integer.parseInt(valueData.get(2));
					int i5 = Integer.parseInt(valueData.get(3));
					int i6 = Integer.parseInt(valueData.get(4));
					igsa.serverInformPlayerActionOnlyCard(valueData.get(1), i4, i5, i6);
				...
				int i3 = Integer.parseInt(valueData.get(3));
				int i4 = Integer.parseInt(valueData.get(4));
				igsa.serverInformPlayerActionOnlyTRNotCard(i1, i2, i3, i4);
				
				
			}
			else if(valueData.size() == 6 && valueData.get(1).equals("true") ) {
				boolean i1 = Boolean.parseBoolean(valueData.get(1));
				int i4 = Integer.parseInt(valueData.get(3));
				int i5 = Integer.parseInt(valueData.get(4));
				int i6 = Integer.parseInt(valueData.get(5));
				igsa.serverInformPlayerActionOnlyTR(i1, valueData.get(2), i4, i5, i6);
			}
			else {
				boolean i1 = Boolean.parseBoolean(valueData.get(2));
				int i4 = Integer.parseInt(valueData.get(3));
				int i5 = Integer.parseInt(valueData.get(4));
				int i6 = Integer.parseInt(valueData.get(5));
				igsa.serverInformPlayerActionOnlyReverse(valueData.get(1),i1, i4, i5, i6);
			}
