...
//		assertEquals(true,fs.getNc().getRunningTCP());
	...
	public void testBUDP() {
		...
		EasyMock.expect(serverInformation.getstatut()).andReturn("ATTENTE");
		EasyMock.replay(serverInformation);
		assertEquals("ATTENTE", serverInformation.getstatut());
		...
		EasyMock.verify(actionPlayer);
		EasyMock.verify(serverInformation);
	...
	public void testJActionPlayer() {
		resetMock();
		actionServer.serverInformPlayerActionTRandReverseGame(true, "Roi.14", true, 123, 123, 123);
		actionServer2.serverInformPlayerActionTRandReverseGame(true, "Roi.14", true, 123, 123, 123);
		EasyMock.replay(actionServer);
		EasyMock.replay(actionServer2);
		...
		resetMock();
		actionServer.serverInformPlayerActionOnlyTR(true, "Roi.14", 123, 123, 123);
		actionServer2.serverInformPlayerActionOnlyTR(true, "Roi.14", 123, 123, 123);
		EasyMock.replay(actionServer);
		EasyMock.replay(actionServer2);
		...
		resetMock();
		actionServer.serverInformPlayerActionOnlyReverse("Roi.14", true, 123, 123, 123);
		actionServer2.serverInformPlayerActionOnlyReverse("Roi.14", true, 123, 123, 123);
		EasyMock.replay(actionServer);
		EasyMock.replay(actionServer2);
		...
		resetMock();
		actionServer.serverInformPlayerActionOnlyCard("Roi.14", 123, 123, 123);
		actionServer2.serverInformPlayerActionOnlyCard("Roi.14", 123, 123, 123);
		EasyMock.replay(actionServer);
		EasyMock.replay(actionServer2);
	...
	public void testMRentreTroupeau() {
		resetMockPlayer();
		actionPlayer.joueurRentreTroupeau("true", "123", "idm", "idt");
		EasyMock.replay(actionPlayer);
	...
	public void testNPlayCard() {
		resetMockPlayer();
		actionPlayer.joueurAJouerCarte("Valet.7", "132","132", "132");
		EasyMock.replay(actionPlayer);
	...
	public void testOEndGame() {
		resetMockPlayer();
		actionPlayer.joueurInverseSensJeu("true", "123", "123", "123");
		EasyMock.replay(actionPlayer);
